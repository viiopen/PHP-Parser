...
abstract class ParserAbstract
{
    ...
    /** @var array Options array (currently only errorCallback) */
    protected $options;
     ...
     * @param array $options Options array (currently only errorCallback)
     */
                    ...
                    switch ($errorState) {
                        case 0:
                            ...
                            if ($this->options['errorCallback']) {
                                $this->options['errorCallback']($msg, $startAttributes['startLine']);
                            } else {
                                throw new Error($msg, $startAttributes['startLine']);
                            }
